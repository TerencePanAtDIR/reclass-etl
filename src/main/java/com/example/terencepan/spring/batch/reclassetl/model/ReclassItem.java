...
public class ReclassItem {
    ...
    public boolean isReclassExists() {
        return reclassExists;
    }

    public void setReclassExists(boolean reclassExists) {
    ...
    public boolean equals(Object o) {
        ...
        ReclassItem that = (ReclassItem) o;
        return eventId == that.eventId &&
                reclassExists == that.reclassExists &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(eventId, arRootDocument, fiscalYear, acct1200000Amount, reclassExists, programUnitCode, eventDate, fsSequenceNumber, streetAddress, city, stateCode, zipCode, countryCode, country, organizationName, legalName, dba, custId, agencySourceCode, revenueSourceCode, indexCode, dataSourceCode, fund, createdBy, createdDate, modifiedBy, modifiedDate);
    }
